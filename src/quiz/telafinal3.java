 ...
 * @author Ana Paula
 */
public class telafinal3 extends javax.swing.JFrame {

    /**
     * Creates new form telafinal3
     */
    public telafinal3() {
        initComponents();
        setSize(777, 501);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(10, 10, 210, 200);
        ...
        jButton1.setBounds(100, 320, 180, 70);
        ...
        jButton2.setBounds(440, 320, 180, 70);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       new telafinal4().setVisible(true);
       dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(telafinal3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
